...
with model2_graph.as_default():
    ...
    net_model2 = res18.Network(cf.MODEL2_TRA_CKPT_PATH, trainable=False, fine_tuning=False)
...
with model2_sess.as_default():
    with model2_graph.as_default():
        ...
        loader2.restore(model2_sess, cf.MODEL2_TES_CKPT_PATH)
...
for i in range(0, end):
    ...
    if batch_sz_next != 0:
      ...
      with model2_sess.as_default():
        with model2_graph.as_default():
          r3, r4 = model2_sess.run([net_model2.prob, net_model2.fc8_d1], feed_dict={images_model2: im_list_next, train_mode_model2:False})
